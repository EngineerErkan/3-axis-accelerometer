...
//1533841/443740/2.49/39/4/Antenna
...
(library Library_1
	...
	(patternDef "ESP32WROOM32D" (originalName "ESP32WROOM32D")
		...
		(layerContents (layerNumRef 18)
			(arc (pt -9.75, 5.55) (radius 0.1) (startAngle 270) (sweepAngle -180.0) (width 0.2))
		)
	)
	(symbolDef "ESP32-WROOM-32D" (originalName "ESP32-WROOM-32D")
	...
	(compDef "ESP32-WROOM-32D" (originalName "ESP32-WROOM-32D") (compHeader (numPins 39) (numParts 1) (refDesPrefix ANT)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ESP32-WROOM-32D"))
		...
		(attr "Manufacturer_Part_Number" "ESP32-WROOM-32D")
		(attr "Mouser Part Number" "N/A")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Espressif-Systems/ESP32-WROOM-32D/?qs=MLItCLRbWszx2KabkKPu5A%3D%3D")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "WiFi Modules (802.11) SMD Module, ESP32-D0WD, 32Mbits SPI flash, UART mode, PCB antenna")
		(attr "<Hyperlink>" "https://www.mouser.com/datasheet/2/891/esp32-wroom-32d_esp32-wroom-32u_datasheet_en-1365844.pdf")
		(attr "<Component Height>" "3.1")
		(attr "<STEP Filename>" "ESP32-WROOM-32D.stp")
